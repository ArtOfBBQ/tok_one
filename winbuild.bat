...
gcc -g -Wall src\windows\main.c src\shared\window_size.c src\shared\zpolygon.c src\shared\software_renderer.c -l opengl32 -l gdi32 -o build\windows\hello3dgfx.exe
