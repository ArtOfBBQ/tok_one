...
typedef enum : u16 {
    ...
    T1_IO_MOUSE = 153,
    T1_IO_MOUSE_LCLICK = 154,
    T1_IO_MOUSE_MCLICK = 155,
    T1_IO_MOUSE_RCLICK = 156,
    T1_IO_MOUSE_OTHERCLICK1 = 157,
    T1_IO_MOUSE_OTHERCLICK2 = 158,
    T1_IO_MOUSE_OTHERCLICK3 = 159,
    T1_IO_MOUSE_OTHERCLICK4 = 160,
    T1_IO_MOUSE_WHEEL_UP = 161,
    T1_IO_MOUSE_WHEEL_DOWN = 162,
    T1_IO_GAMEPAD_DPAD_LEFT = 163,
    T1_IO_GAMEPAD_DPAD_RIGHT = 164,
    T1_IO_GAMEPAD_DPAD_UP = 165,
    T1_IO_GAMEPAD_DPAD_DOWN = 166,
    T1_IO_GAMEPAD_LEFTSHOULDER = 167,
    T1_IO_GAMEPAD_RIGHTSHOULDER = 168,
    T1_IO_GAMEPAD_LEFTTRIGGER = 169,
    T1_IO_GAMEPAD_RIGHTTRIGGER = 170,
    T1_IO_GAMEPAD_LEFTTHUMBSTICKBUTTON = 171,
    T1_IO_GAMEPAD_RIGHTTHUMBSTICKBUTTON = 172,
    T1_IO_GAMEPAD_LEFTTHUMBSTICK = 173,
    T1_IO_GAMEPAD_RIGHTTHUMBSTICK = 174,
    T1_IO_GAMEPAD_A = 175,
    T1_IO_GAMEPAD_B = 176,
    T1_IO_GAMEPAD_X = 177,
    T1_IO_GAMEPAD_Y = 178,
    T1_IO_GAMEPAD_HOME = 179,
    T1_IO_GAMEPAD_MENU = 180,
    T1_IO_GAMEPAD_OPTIONS = 181,
