...
{
    memset(stack_recipient, 0, sizeof(LineRequest));
...
{
    memset(recipient, 0, sizeof(LineRequest));
...
{
    memset(stack_recipient, 0, sizeof(PointRequest));
...
bool32_t fetch_point_by_object_id(
    ...
    const int32_t object_id)
{
    memset(recipient, 0, sizeof(PointRequest));
