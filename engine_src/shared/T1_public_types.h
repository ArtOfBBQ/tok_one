...
typedef enum : u16 {
    ...
    T1_IO_GAMEPAD_DPAD_LEFT = 162,
    T1_IO_GAMEPAD_DPAD_RIGHT = 163,
    T1_IO_GAMEPAD_DPAD_UP = 164,
    T1_IO_GAMEPAD_DPAD_DOWN = 165,
    T1_IO_GAMEPAD_LEFTSHOULDER = 166,
    T1_IO_GAMEPAD_RIGHTSHOULDER = 167,
    T1_IO_GAMEPAD_LEFTTRIGGER = 168,
    T1_IO_GAMEPAD_RIGHTTRIGGER = 169,
    T1_IO_GAMEPAD_LEFTTHUMBSTICKBUTTON = 170,
    T1_IO_GAMEPAD_RIGHTTHUMBSTICKBUTTON = 171,
    T1_IO_GAMEPAD_A = 172,
    T1_IO_GAMEPAD_B = 173,
    T1_IO_GAMEPAD_X = 174,
    T1_IO_GAMEPAD_Y = 175,
    T1_IO_GAMEPAD_HOME = 176,
    T1_IO_GAMEPAD_MENU = 177,
    T1_IO_GAMEPAD_OPTIONS = 178,
