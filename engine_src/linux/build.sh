...
if [[ $1 = "DEBUG" ]]; then
    COMPILER_OPTIONS="-D LINUX_PLATFORM -fsanitize=address -w -Wfatal-errors -pthread -I engine_src -I client_src -I sampleproject_src -I engine_src/shared -I engine_src/shared_opengl -march=native -x c -std=c99 -o0 -g"
else
    if [[ $1 = "RELEASE" ]]; then
        COMPILER_OPTIONS="-D LINUX_PLATFORM -w -Wfatal-errors -pthread -I engine_src -I client_src -I sampleproject_src -I engine_src/shared -I engine_src/shared_opengl -march=native -x c -std=c99 -o0"
    else
