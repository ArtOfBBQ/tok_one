...
//    log_assert(to_add->width > 0.0f);
//    
//    float offset_left = to_add->left_x + to_add->x_offset;
//    float offset_top = to_add->top_y + to_add->y_offset;
//    
//    float parent_quad_middle_x =
//        offset_left + (to_add->width / 2) - camera.x;
...
//                (extra_scale * 0.5f * to_add->height);
...
//            && texquads_to_render[i].left_x -
//                (texquads_to_render[i].ignore_camera ? 0 : camera.x)
//                    <= 1.0f
//            && texquads_to_render[i].left_x +
//                texquads_to_render[i].width -
//                    (texquads_to_render[i].ignore_camera ? 0 : camera.x) >= -1.0f
//            && texquads_to_render[i].top_y -
