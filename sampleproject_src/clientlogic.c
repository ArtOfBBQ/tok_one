...
void client_logic_startup() {
    ...
    zPolygon quad = construct_quad(
        ...
        /* float height: */
            2.0f);
    for (uint32_t tri_i = 0; tri_i < quad.triangles_size; tri_i++) {
        quad.triangles[tri_i].texturearray_i = -1;
        quad.triangles[tri_i].texture_i      = -1;
        quad.triangles[tri_i].color[0]       = 1.0f;
        quad.triangles[tri_i].color[1]       = 1.0f;
        quad.triangles[tri_i].color[2]       = 1.0f;
        quad.triangles[tri_i].color[3]       = 1.0f;
    }
    quad.ignore_lighting = true;
    request_zpolygon_to_render(&quad);
